 ...
 */
export async function getUserCompletedTaskIds(userId) {
    try {
        const { data, error } = await supabase
            .from("user_tasks")
            .select("task_id")
 ...
 */
export async function isTaskCompletedByUser(userId, taskId) {
    try {
        const { data, error } = await supabase
            .from("user_tasks")
            .select("id")
 ...
 */
export async function getTasksWithCompletionStatus(userId) {
    try {
