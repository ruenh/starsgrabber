 ...
 */
export function generateReferralLink(telegramId, botUsername) {
 ...
 */
export async function processReferralBonus(userId, taskId, taskReward) {
    try {
        // Get user's referrer
        ...
        await createTransaction(user.referrer_id, "referral", referralBonus, taskId, userId // referral_id is the user who completed the task
        );
 ...
 */
export async function getReferralTransactions(userId) {
    try {
