import { createTask, updateTask, closeTask, getAllTasks, getPendingWithdrawals, approveWithdrawal, rejectWithdrawal, getAdminStats, getReferralTree, } from "../services/adminService.js";
 ...
 * GET /api/admin/tasks
 */
export async function getAllTasksAdmin(_req, res) {
    try {
 ...
 */
export async function createTaskAdmin(req, res) {
    try {
 ...
 */
export async function updateTaskAdmin(req, res) {
    try {
 ...
 */
export async function closeTaskAdmin(req, res) {
    try {
        const taskId = parseInt(req.params.id, 10);
        if (isNaN(taskId)) {
            return res.status(400).json({
 ...
 */
export async function getPendingWithdrawalsAdmin(_req, res) {
    try {
 ...
 */
export async function approveWithdrawalAdmin(req, res) {
    try {
 ...
 */
export async function rejectWithdrawalAdmin(req, res) {
    try {
        const withdrawalId = parseInt(req.params.id, 10);
 ...
 * GET /api/admin/stats
 */
export async function getStatsAdmin(_req, res) {
    try {
 ...
 */
export async function getReferralTreeAdmin(_req, res) {
    try {
