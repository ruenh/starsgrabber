import { getActiveBanners, createBanner, updateBanner, deleteBanner, getAllBanners, } from "../services/bannerService.js";
 ...
 */
export async function createBannerAdmin(req, res) {
    try {
 ...
 */
export async function updateBannerAdmin(req, res) {
    try {
 ...
 */
export async function deleteBannerAdmin(req, res) {
    try {
        const bannerId = parseInt(req.params.id);
        if (isNaN(bannerId)) {
            return res.status(400).json({
 ...
 */
export async function getAllBannersAdmin(_req, res) {
    try {
