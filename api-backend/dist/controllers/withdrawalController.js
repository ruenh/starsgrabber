import { createWithdrawalRequest, getUserWithdrawals, } from "../services/withdrawalService.js";
...
export async function createWithdrawal(req, res) {
    try {
        ...
        if (user && user.username) {
            await NotificationService.notifyAdminWithdrawalRequest(user.username, amount, userId, withdrawal.id);
        }
